...
public class RegisterRoomActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Toolbar tbarRegisterRoom = findViewById(R.id.tbarRegisterRoom);
        setSupportActionBar(tbarRegisterRoom);
        ...
        Button btnRegRoom = findViewById(R.id.btnRegRoom);
        btnRegRoom.setOnClickListener(new View.OnClickListener() {

            @Override
            public void onClick(View v) {
                Toast.makeText(RegisterRoomActivity.this, "SE REGISTRO UN NUEVA SALA", Toast.LENGTH_SHORT).show();
